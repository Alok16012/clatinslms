...
const NavHomeIcon = ({ active }: { active: boolean }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path d="M3 10.5L12 3L21 10.5V20C21 20.55 20.55 21 20 21H15V16H9V21H4C3.45 21 3 20.55 3 20V10.5Z"
      fill={active ? "#1B2B6B" : "none"}
      stroke={active ? "#1B2B6B" : "#9CA3AF"}
...
const NavDoubtsIcon = ({ active }: { active: boolean }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"
      ...
      stroke={active ? "#1B2B6B" : "#9CA3AF"}
      strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="8.5" cy="11" r="1" fill={active ? "#1B2B6B" : "#9CA3AF"} />
    <circle cx="12" cy="11" r="1" fill={active ? "#1B2B6B" : "#9CA3AF"} />
    <circle cx="15.5" cy="11" r="1" fill={active ? "#1B2B6B" : "#9CA3AF"} />
  </svg>
);
          ...
          >
            ...
            {isStudy ? (
              <div style={{
                ...
                gap: "2px",
                marginTop: "-14px",
                boxShadow: "0 6px 18px rgba(27,43,107,0.40)",
                minWidth: 72,
              }}>
                <NavStudyIcon />
