...
export const HomeIcon = ({ active }: { active?: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? "#1B2B6B" : "none"} stroke={active ? "#1B2B6B" : "#9CA3AF"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const CoursesIcon = ({ active }: { active?: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={active ? "#1B2B6B" : "#9CA3AF"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ChevronRight = ({ color = "#1B2B6B" }: { color?: string }) => (
...
export const UploadIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1B2B6B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
