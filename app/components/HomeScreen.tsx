...
const liveClasses = [
  {
    ...
    time: "4:00 PM",
    topic: "Landmark SC Judgements",
    viewers: "1.2k",
    color: "#1B2B6B",
    bg: "linear-gradient(135deg,#1B2B6B,#2D4499)",
    emoji: "⚖️",
  },
  {
    subject: "English & GK",
    teacher: "Rahul Verma Sir",
    time: "6:00 PM",
...
const successStories = [
  { name: "Shreya Agarwal", college: "NLU Delhi", rank: "AIR 3", initials: "SA", color: "#1B2B6B" },
  { name: "Varun Nair", college: "NLU Bangalore", rank: "AIR 7", initials: "VN", color: "#DC2626" },
    ...
    <div style={{ background: "#F0F4FF", paddingBottom: 20 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, zIndex: 1, flexShrink: 0 }}>
            ...
            <button style={{
              ...
              whiteSpace: "nowrap",
              boxShadow: "0 4px 12px rgba(27,43,107,0.4)",
            }}>Register Now</button>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "20px 14px 0" }}>
          ...
          <div style={{ display: "flex" }}>
            {["AG", "RM"].map((init, i) => (
              <div key={i} style={{
                ...
                background: i === 0 ? "linear-gradient(135deg,#1B2B6B,#4263C8)" : "linear-gradient(135deg,#DC2626,#EF4444)",
        ...
        <button onClick={() => onNavigate("study")} style={{
          ...
          color: "#1B2B6B", fontSize: 14, fontWeight: 700,
        }}>
      ...
      <div style={{ padding: "22px 14px 0" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
          <h3 style={{ margin: 0, fontSize: 18, fontWeight: 800, color: "#1A1A2E" }}>Live Classes Today</h3>
          <button style={{ background: "none", border: "none", color: "#1B2B6B", fontSize: 13, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: 2 }}>
            ...
            <div key={i} style={{
              ...
              <div style={{ flex: 1, padding: "13px 14px", display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div style={{
                  ...
                  boxShadow: `0 4px 12px ${cls.color}40`,
                }}>
                  {cls.emoji}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                    <span style={{ fontSize: 14, fontWeight: 800, color: "#1A1A2E" }}>{cls.subject}</span>
                    <span style={{
                  ...
                  <p style={{ margin: 0, fontSize: 12, color: "#374151", fontWeight: 500 }}>{cls.topic}</p>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4 }}>
                    <span style={{ fontSize: 10.5, color: "#9CA3AF" }}>{cls.teacher}</span>
                    <span style={{ fontSize: 10, color: "#9CA3AF" }}>•</span>
                    <span style={{ fontSize: 10.5, color: "#9CA3AF" }}>⏰ {cls.time}</span>
                    <span style={{ fontSize: 10, color: "#9CA3AF" }}>•</span>
                    <span style={{ fontSize: 10.5, color: "#9CA3AF" }}>👁 {cls.viewers}</span>
                  </div>
                </div>
                <button style={{
                  background: "linear-gradient(135deg,#1B2B6B,#2D4499)",
                  ...
                  fontSize: 12, fontWeight: 700, cursor: "pointer",
                  boxShadow: "0 3px 10px rgba(27,43,107,0.3)",
                  whiteSpace: "nowrap",
                }}>Join →</button>
              </div>
            </div>
      ...
      <div style={{ padding: "22px 14px 0" }}>
        <div style={{
          background: "linear-gradient(135deg,#1B2B6B 0%,#243A8B 60%,#1B2B6B 100%)",
          borderRadius: 22,
          padding: "18px 16px",
          position: "relative",
          overflow: "hidden",
          boxShadow: "0 6px 24px rgba(27,43,107,0.3)",
        }}>
          {/* bg circles */}
      ...
      <div style={{ padding: "22px 14px 0" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
          ...
          <button style={{ background: "none", border: "none", color: "#1B2B6B", fontSize: 13, fontWeight: 700, cursor: "pointer" }}>See all</button>
        </div>
